                ...
                .map(row -> {
                    try {
                        ...
                        return ForwardQuestionDTO.builder()
                                ...
                                .fromDepartment(new ForwardQuestionDTO.DepartmentDTO(fromDepartmentId, null))
                                .toDepartment(new ForwardQuestionDTO.DepartmentDTO(toDepartmentId, null))
                                .consultant(new ForwardQuestionDTO.ConsultantDTO(consultantId, null, null))
