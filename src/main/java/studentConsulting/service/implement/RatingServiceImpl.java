...
public class RatingServiceImpl implements IRatingService{
	...
	@Override
    public Page<RatingDTO> getRatingsByUserAndDepartmentAndConsultantName(UserInformationEntity user, Integer departmentId, String consultantName, Pageable pageable) {
        Page<RatingEntity> ratings = ratingRepository.findByUserAndDepartmentAndConsultantName(user, departmentId, consultantName, pageable);
        return ratings.map(this::mapToDTO);
    }

    @Override
    public Page<RatingDTO> getRatingsByUserAndDepartment(UserInformationEntity user, Integer departmentId, Pageable pageable) {
        Page<RatingEntity> ratings = ratingRepository.findByUserAndDepartment(user, departmentId, pageable);
        return ratings.map(this::mapToDTO);
    }

    @Override
    public Page<RatingDTO> searchRatingsByUserAndConsultantName(UserInformationEntity user, String consultantName, Pageable pageable) {
