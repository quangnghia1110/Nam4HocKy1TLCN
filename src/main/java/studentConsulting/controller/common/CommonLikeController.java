...
public class CommonLikeController {

    private final ICommonLikeRecordService likeRecordService;
    ...
    @Autowired
    public CommonLikeController(ICommonLikeRecordService likeRecordService, CommentRepository commentRepository,
